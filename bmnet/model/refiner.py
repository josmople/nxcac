...
def build_refiner(refiner="self_similarity_module", hidden_dim=256, refiner_proj_dim=32, refiner_layers=1):
    refiner_name = refiner
    # print(refiner_name)

    if refiner_name == 'self_similarity_module':
        return SelfSimilarityModule(
            hidden_dim=hidden_dim,
            proj_dim=refiner_proj_dim,
            layer_number=refiner_layers
        )
