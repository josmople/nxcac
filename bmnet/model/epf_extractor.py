...
def build_epf_extractor(epf_extractor="direct_pooling", backbone_layer="layer3", hidden_dim=256, repeat_times=1,ep_scale_embedding=True,ep_scale_number=20):
    extractor_name = epf_extractor
    input_dim = 1024 if backbone_layer == 'layer3' else 2048
    if extractor_name == 'direct_pooling':
        return DirectPooling(
            input_dim=input_dim,
            hidden_dim=hidden_dim,
            repeat_times=repeat_times,
            use_scale_embedding=ep_scale_embedding,
